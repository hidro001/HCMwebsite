...
const VideoComponent = ({ videoSrc, thumbnailSrc, playButton }) => {
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto mt-8 px-2 sm:px-4 lg:px-6">
      <div className="relative w-full rounded-lg overflow-hidden shadow-lg">
        {/* Video Element */}
        <video ref={videoRef} src={videoSrc} className="w-full" controls={isPlaying} />
        ...
        {!isPlaying && (
          <div className="absolute inset-0 cursor-pointer z-10" onClick={handlePlay}>
            ...
            {thumbnailSrc && (
              <img src={thumbnailSrc} alt="Video Thumbnail" className="absolute inset-0 w-full h-full object-cover" />
            )}
