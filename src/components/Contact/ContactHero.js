    ...
    <div className="relative  mx-40 bg-[#C6E08E] p-20 mt-36 rounded-lg flex items-center justify-between">
      <div className="flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="w-full md:w-1/2 mb-8 md:mb-0">
          <div className="inline-block px-4 py-1 bg-amber-200 rounded-full text-gray-800 font-medium text-sm mb-4">
            HRMS SOFTWARE
          </div>
          ...
          <p className="text-lg text-gray-800 mb-6">
            ...
            <span className="text-pink-600 font-bold"> HCM</span> software was created to help you manage your staff more effectively
            and simply. As a result, companies are better able to hire, retain, and develop employees.
          </p>

          <a href="#"
            className="inline-block px-8 py-3 bg-purple-900 text-white font-medium rounded-full hover:bg-purple-800 transition-colors">
            Explore Now
          </a>
        </div>
        ...
        <div className="w-full md:w-1/2 flex justify-center">
          <div className="relative">
            <div className="w-72 h-72 md:w-80 md:h-80 bg-purple-600 rounded-full"></div>
